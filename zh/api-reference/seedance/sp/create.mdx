...
|------|-------------|------|------|----------|
| **经济版** | `sd2_sp_720p`、`sd2_sp_1080p`、`sd2_sp_2k`、`sd2_sp_4k` | 按秒 | 4–15 秒 | 支持公网 URL 或素材库 |
| **经济版 Fast** | `sd2_sp_fast_780p` | 按秒 | 4–15 秒 | 同上；不支持 `reference_videos` |
| **视频参考** | `sd2_sp_video_720p`、`sd2_sp_video_1080p`、`sd2_sp_video_2k`、`sd2_sp_video_4k` | 按秒 | 4–15 秒 | 同上；支持 `reference_videos` |
...
| `resolution` | string | 否 | 输出分辨率：`720p`（默认）、`1080p`；**不支持 `480p`** |
