...
<Note>
This uses the same endpoint as [Create Seedance Video](/en/api-reference/seedance/create): `POST /api/open-api/v1/seedance/videos`. For Full (Manxue), see the general create doc; for MD, see [MD Create Video](/en/api-reference/seedance/md/create).
</Note>
