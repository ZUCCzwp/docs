...
<Note>
本接口与 [创建 Seedance 视频](/zh/api-reference/seedance/create) 共用 `POST /api/open-api/v1/seedance/videos`。满血版见通用创建文档，MD 见 [MD 创建视频](/zh/api-reference/seedance/md/create)。
</Note>
