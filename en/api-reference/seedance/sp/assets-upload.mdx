...
<Note>
This endpoint is for **SP economy** models (`seedance2.0-sp` / `seedance2.0-fast-sp`). For the full Manxue route, use [Submit Asset Audit](/en/api-reference/seedance/assets-audit).
</Note>
